...
//         Sample data
        val books = listOf(
            ...
            Book("ሌላሠው", "ምህረት ደበበ", R.drawable.lelasew,451, "ይህ የአማርኛ ልቦለድ፣ የአእምሮ ህክምና ባለሙያ በስልጠና ለዶክተር ምህረት ደበበ ገብረፃድቅ ሁለተኛ መጽሐፍ ነው። ‘ሌላሰው’ የሚለው ማዕረግ ልቅ ማለት ‘ሌላው ሰው’ ማለት ነው። ስለ ስብዕና እና ስብዕና የሚገልጽ መጽሐፍ ነው። የኢትዮጵያን ወቅታዊ የህብረተሰብ ጉዳዮች ይዳስሳል። አብዛኛዎቹ ዋና ዋና የአእምሮ ሕመሞች በታሪኩ ውስጥ ተካተዋል. የምንችለውን እና የምንችለውን የሚገልጥ እውነታ ሆኖ ተጽፏል። በግል ምቾት እና በህብረተሰብ አስተዋፅዖ መካከል ያለውን ሚዛን ለመጠበቅ የሚታገል የቤተሰብ ጉዞ ታሪክ ነው። ዋናው ገፀ ባህሪ ፣ እራሱ የስነ-አእምሮ ሃኪም የህይወት ህልሙን እና የመጀመሪያ ፍቅሩን እያሳደደ ቤተሰቡን አንድ ላይ ለማቆየት ይዋጋል። በታሪኩ ውስጥ ያሉ ሁሉም ሰዎች ወደ ግል ፍላጎታቸው ሲዘምቱ እና ፍላጎታቸው ሊታረቅ በማይችልበት ጊዜ ታሪኩ ባልተጠበቀ መልኩ ይጣመማል።", 2008, "ልብ ወለድ"),
            ...
            Book("ሰመመን","ሲሳይ ንጉሱ", R.drawable.sememen, 378,"በዩኒቨርሲቲ ሕይወት ዙሪያና በፍቅር ታሪክ ላይ በሚያተኩረው ሰመመን በሚባለው መጽሐፋቸው በብዙዎች ዘንድ የታወቁት ሲሳይ ንጉሡ፣ ጉዞው፣ ግርዶሽ፣ የቅናት ዛር የተባሉ ረጃጅም ልብወለዶች አሏቸው፡፡ ጉዞው የሚለውን ኖቬላ ጨምሮ ሌሎች አጫጭር ልብወለዶችን ጽፈዋል፡፡ ከኢትዮጵያ ሥነ ጥበባትና መገናኛ ብዙኃን ሽልማት በሥነ ጽሑፍ ዘርፍ በ 1991 ዓ.ም. ተሸላሚም ሆነዋል፡፡ ቀደም ባሉት ጊዜያት የደራሲያን ማኀበር ዋና ጸሐፊ በመሆን አገልግለዋል፡፡", 2001, "ልብ ወለድ"),
            Book("አንድ ቀን", "ኪሩበል ግርማ", R.drawable.and_ken,52,"something", 2001, "ግጥም"),
            Book("የቀይ ኮከብ ጥሪ", "በዓሉ ግርማ",R.drawable.keykokeb,372,"ደራሲ በዓሉ ግርማ በተለይ በልብ ወለድ እና በፈጠራ የሥነ ጽሑፍ ሥራዎች ከታወቁት የኢትዮጵያ የዘመኑ ደራሲዎች መካከል ተወዳጅነትና ዝናን ያተረፉ ዕውቅ ደራሲ ነበሩ። ከጻፏቸው በርካታ ድርሰቶቻቸው ውስጥ «ከአድማስ ባሻገር» የተሰኘው መጽሐፋቸው በሩስኛ ቋንቋ ተተርጉሞ በቀድሞዋ የሶቪየት ሶሽያሊስት ሕብረት ሪፑብሊክ ቀርቧል። በተጨማሪም በጋዜጠኝነት ሙያም ስማቸውን ያስጠሩ፤ ሙያቸውንም ያስከበሩ ደራሲ ነበሩ። «የዛሬይቱ ኢትዮጵያ» ጋዜጣ፤ የመነን መጽሔት፤ የአዲስ ሪፖርተር መጽሔት፤ የአዲስ ዘመን ጋዜጣ ዋና አዘጋጅ በመሆን ከመሥራታቸውም ባሻገር፤ ብዙ ወጣት ጋዜጠኞችን ለማፍራት ጥረት አድርገዋል። አዲስ ሪፖርተር የተባለውን መጽሔትም ደረጃው ከፍ እንዲልና በዓለም አቀፍ ደረጃ እንዲገመገም አድርገዋል። በጋዜጠኝነት ሙያቸው በኢትዮጵያ ራዲዮ ሠርተዋል።\n" +
                    "\n" +
                    "ደራሲ በዓሉ ግርማ ለኢትዮጵያ ሥነጽሑፍ ከፍተኛ አስተዋጽኦ ያበረከቱና ብዙ ሥራዎችን ያቀረቡ ሲሆን፤ የመጨረሻው መጽሐፋቸው «ኦሮማይ» በመባል ይታወቃል። ይኼውም መጽሐፍ በወቅቱ በነበረው የደርግ መንግሥት ሊደገፍ ባለመቻሉ በ1976 ዓ.ም. ለደራሲው ሕይወት መጥፋት መንስኤ ሊሆን በቅቷል።", 2001, "ልብ ወለድ"),
            Book("ንዝረት", "ዘሪሁን ገመ 2",R.drawable.nzret,106,"something", 2001, "ግጥም"),
            Book("ዳግማዊ አጤሚኒልክ", "አፈወረቅ ገብረእየሱስ", R.drawable.menelik,115,"something", 2001, "ግጥም"),
            Book("ኦሪጅን", "ሃኒም ኤልያስ",R.drawable.origin,468,"something", 2001, "ልብ ወለድ"),
            Book("አልሞትኩም", "ኪሩበል ኩማ",R.drawable.almotkum,61,"something", 2001, "ግጥም"),
            Book("አፍላ ገጾች", "ዮናስ መስፍን",R.drawable.aflagetsoch,90,"something", 2001, "ግጥም"),
            ...
            Book("ባይብል ኮድ(BIBLE CODE)", "ሃሊም ኤልያስ", R.drawable.biblecode,296, "something", 2001, "ግጥም"),
            Book("የመጨረሻዋ እለት", "አብረሃም በእውቀት", R.drawable.yemechereshawaelet,78, "something", 2001, "ግጥም"),
            Book("ጨው በረንዳ", "ምስራቅ ተረፈ",R.drawable.chewberenda,71, "something", 2001, "ግጥም"),
            Book("ችቦ", "አለማየሁ ዋሴ እሸቴ", R.drawable.chbo,200, "\n" +
                    "ሰበዝ ቁ.2 ልትሉት የምትችሉት መጸሐፍ ከች ብሏል!! 16 አጫጭር ታሪኮችን ይተርክልናል... ምን ተብላችኋል መሰላችሁ...\n" +
                    "#ዶክተር ዓለማየሁ ዋሴ \"ይህ ችቦ በሚል ርዕስ የቀረበው ስድስተኛ መጽሐፌ ቀደም ሲል 'ሰበዝ' ከታተመው መጸሐፌ በቅርፅም በይዘትም ተመሳሳይ ሲሆን ከሰበዝ የሚቀጥል ታሪክ ግን የለውም። ችቦ ማለት ቀጫጭን እንጨቶች በአንድ ላይ ታስረው ብርሃን እንዲሰጡ ወይም ደመራ ለመለኮስ የሚዘጋጅ ማለት ነው፡፡ አንዳንዶቹ እንጨቶች ለብቻቸው የሚነዱ ቢሆንም አንድ ላይ ታስረው ሲቀጣጠሉ ግን ትልቅ ብርሃን ከመሆን አልፈው ትልቅ ዳመራን ማቀጣጠል ይችላሉ፡፡\n" +
                    "እውነተኛ ገጠመኞቹን ተንተርሰው የቀረቡት አጫጭር ተረኮች ታሪኮች እያነበባችሁ...",2000, "ልብ ወለድ "),

...
//         Sample data
        val books = listOf(
            ...
            Book(
                ...
                R.drawable.sememen,
                272,
                "ደራሲው ;ሲሳይ ንጉሱ ይባላል በ1977  የፃፈው መፅሀፍ ነው በውስጡም 272 ገፆች አሉት ግርዶሽ,ትንሳኤ,የቅናት ዛር እና ረቂቅ አሻራ የሚባሉም ተጨማሪ የሱ መፅሀፍት ናቸው::\n" +
                        "መፅሀፉ መቼት ያረገው ዩንቨርስቲ ላይ ሲሆን የገፀባህሪያቱም ስም አቤል;ትዕግስት;እስክንድር;ማርታ ;ቤቴልሔም;ዮናታን ናቸው:: ታሪኩ የሚያጠነጥነው የአንድ ወጣት ሰቃይ ተማሪ በአይን ፍቅር መያዝና በዛም ፍቅር ም/ት የሚሰቃየውን ስቃይ ያስቀኛል በመጨረሻም በጓደኞቹና በመምህሩ ያላሰለሰ ጥረት ለፍቅሩ እስትንፋስ ለሆነችው ልጅ እንደሚወዳት ሲናገር ያበቃል::",
                1977,
                "ልብ ወለድ"
            ),
            Book(
            ...
            Book(
                ...
                R.drawable.keykokeb,
                264,
                "ከዚያ በፊት በአሉ በተለያዩ የተማሪ መጽሔቶች (የጄነራል ዊንጌቱ “Chindit” እና የዩኒቨርስቲ ኮሌጁ “News and Views”) ግጥሞቹን ማቅረብ ለምዶ ነበር። ከፈጠራ ድርሰት ባሻገርም በጋዜጣና መጽሔት አዘጋጅነት (“News and Views”፣ “Addis Reporter”፣ “መነን” እና “አዲስ ዘመን”) የበርካታ አመታት ልምድ ነበረው። በኒህም አመታት በተቻለው መጠን የአዘጋጅነቱን ሚና በመጠቀም (በተለይ በ”መነን” እና “አዲስ ዘመን”) በርካታ ኪነጥበባዊ አምዶችን (ለምሳሌ “አጭር ልብወለድ”፣ “ከኪነጥበባት አካባቢ”) አስጀምሮ  ነበር።",
                1973,
                "ልብ ወለድ"
            ),
